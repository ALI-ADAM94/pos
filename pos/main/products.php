...
<div style="margin-top: -19px; margin-bottom: 21px;">
			<?php 
			include('../connect.php');
				$result = $db->query("SELECT * FROM products ORDER BY qty_sold DESC");
			...
			<?php 
			include('../connect.php');
				$result = $db->query("SELECT * FROM products where qty < 10 ORDER BY product_id DESC");
				
				$rowcount123 = $result->num_rows;
